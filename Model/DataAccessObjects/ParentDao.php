<?php  
    ...
    function findStudents($id){
        $sel = "SELECT b.student_first_name as sfname, b.student_last_name as slname, b.id, b.student_id
                    FROM student b, parent_has_student c
                    WHERE b.id = c.student_id and c.parent_id = '$id'";
        $dbh = dbConnect();
        //$result=mysqli_query($dbh, $sel);
        //if(!$result) $result = "";
        //return $result;
