<?php
    ...
    function callStudentResults($test_id, $subject_id, $stream_id){
        $sel = "SELECT b.student_first_name as sfname, b.student_last_name as slname, a.subject_id,  a.marks
    ...
    function callStudentTestResults($test_id, $student_id){
       $sel = "SELECT b.name, a.marks, d.id
    ...
    function callIndividualResults($studentid, $subjectid){
        $sel = "SELECT a.test_type, a.term, a.year, b.marks
