...
?>		
		...
		<li>
			...
			<footer class="cd-pricing-footer">
				<input type="hidden" name="parentId" id="parentId" value="Parent">
				<a href="#0">Select</a>
		...
		<li>
			...
			<footer class="cd-pricing-footer">
				<input type="hidden" name="adminId" id="adminId" value="Admin">
				<a href="#0">Select</a>
			</footer> <!-- .cd-pricing-footer -->
		</li>
		...
		<li>
			...
			<footer class="cd-pricing-footer">
				<input type="hidden" name="teacherId" id=teacherId" value="Teacher">
				<a href="#0">Select</a>
			</footer> <!-- .cd-pricing-footer -->
		</li>
	</ul> <!-- .cd-pricing -->
